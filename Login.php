...
<body class="bg-white text-[#4a4a4a]">
    ...
    <main class="flex flex-col items-center py-10 px-5">
        ...
        <section class="bg-[#f9f9f9] p-10 rounded-[40px] w-full max-w-[550px] text-center shadow-sm">
            <h1 class="text-[#ff4fa1] text-5xl font-bold">Welcome Back!</h1>
            <h2 class="text-[#ff4fa1] text-4xl font-bold mb-8">Login to your account.</h2>
            ...
            <button class="bg-[#ff4fa1] text-white border-none py-4 w-full rounded-full text-3xl font-bold cursor-pointer mt-5 mb-6">
                Login
            </button>

            <div class="space-y-2">
                <a href="#" class="block text-black font-bold text-lg underline underline-offset-4">Forgot Password?</a>
                <p class="text-black font-bold text-lg">
                    Don't Have an account? <a href="#" class="underline underline-offset-4">Sign up here</a>
                </p>
            </div>
        </section>
    </main>
