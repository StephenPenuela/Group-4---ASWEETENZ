...
<body class="bg-white text-[#4a4a4a]">
    ...
    <main class="flex flex-col items-center py-10 px-5">
        ...
        <section class="bg-[#f9f9f9] p-10 rounded-[40px] w-full max-w-[550px] text-center shadow-sm">
            <h1 class="text-[#ff4fa1] text-5xl font-bold mb-10">Reset Password</h1>

            <div class="text-left mb-6">
                <label class="block text-lg font-bold mb-2 ml-2">New Password <span class="text-[#ff4fa1]">*</span></label>
            ...
            <div class="text-left mb-10">
                <label class="block text-lg font-bold mb-2 ml-2">Confirm New Password <span class="text-[#ff4fa1]">*</span></label>
                <input type="password" placeholder="Enter New Password"
                    class="w-full py-4 px-8 border-[2.5px] border-black rounded-full text-lg outline-none placeholder:text-gray-300 font-semibold">
            </div>

            <button class="bg-[#ff4fa1] text-white border-none py-4 w-full rounded-full text-3xl font-bold cursor-pointer hover:opacity-90 transition-opacity">
                Save New Password
            </button>
        </section>
    </main>
