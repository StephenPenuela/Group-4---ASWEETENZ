...
<head>
    ...
    <title>ASweetenz - Verify Code</title>
    ...
    <main class="flex flex-col items-center py-10 px-5">
        ...
        <section class="bg-[#f9f9f9] p-10 rounded-[40px] w-full max-w-[550px] text-center shadow-sm">
            ...
            <div class="text-left mb-6">
                <label class="block text-lg font-bold mb-2 ml-2">Enter Code <span class="text-[#ff4fa1]">*</span></label>
            ...
            <div>
                <a href="#" class="text-black font-bold text-lg underline underline-offset-4">Return to email verification</a>
            </div>
        </section>
    </main>
