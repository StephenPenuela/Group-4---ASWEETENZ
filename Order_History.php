...
<head>
    ...
    <title>ASweetenz - Order History</title>
...
<body>
    ...
    <main class="main-bg-pattern min-h-screen py-16 px-[10%]">
        ...
        <div class="text-center mb-16 relative">
            <h1 class="pink-text text-6xl font-black uppercase mb-8">Order History</h1>
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="order-card">
                <img src="commission1.png" alt="Product" class="w-40 h-40 object-contain bg-gray-50 rounded-2xl">
                <div class="flex-1 grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div>
                        <h3 class="text-3xl font-black">Item name</h3>
            ...
            <div class="order-card">
                <img src="commission2.png" alt="Product" class="w-40 h-40 object-contain bg-gray-50 rounded-2xl">
                <div class="flex-1 grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div>
                        <h3 class="text-3xl font-black">Item name</h3>
                        <div class="text-lg text-gray-600 space-y-1 mt-4 font-medium">
            ...
            <div class="order-card">
                <img src="commission3.png" alt="Product" class="w-40 h-40 object-contain bg-gray-50 rounded-2xl">
                <div class="flex-1 grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div>
                        <h3 class="text-3xl font-black">Item name</h3>
                        <div class="text-lg text-gray-600 space-y-1 mt-4 font-medium">
