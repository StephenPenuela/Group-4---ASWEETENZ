...
<body>
    ...
    <main class="main-bg-pattern min-h-screen py-12 px-[10%]">
        ...
        <div class="flex flex-wrap justify-center gap-3 mb-8">
            <button class="status-tab active">To Pay/Processing</button>
            <button class="status-tab">To Ship</button>
            <button class="status-tab">To Receive</button>
            <button class="status-tab">Completed</button>
        </div>

        <div class="flex justify-center items-center gap-6 mb-10 text-lg font-bold text-gray-700">
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="order-row">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-gray-500 font-bold italic">Order Descrip</p>
                    <p class="pink-text text-xl font-bold mt-4">100 PHP</p>
                </div>
                <div class="flex-1 text-center">
                    <p class="text-lg font-bold">Order Status: <span class="text-black">Processing Payment</span></p>
                </div>
                <div class="flex-1 text-right flex flex-col gap-2 items-end">
                    <div class="flex gap-2">
                        <button class="btn-action btn-pink">Cancel</button>
                        <button class="btn-action btn-light-pink">Pay Now</button>
                    </div>
                </div>
            </div>
            ...
            <div class="order-row">
                ...
                <div class="flex-1 text-center">
                    <p class="text-lg font-bold">Order Status: <span class="text-black">Unpaid</span></p>
                </div>
                <div class="flex-1 text-right flex flex-col gap-2 items-end">
                    <button class="btn-action btn-pink w-fit">Change Payment Method</button>
                    <div class="flex gap-2">
                        <button class="btn-action btn-pink">Cancel</button>
                        <button class="btn-action btn-light-pink">Pay Now</button>
                    </div>
